...
\begin{lstlisting}[language=bash]
f4c6be6 chore(preview): embed real screenshots in fpdf2 PDF preview (report_with_images.pdf, 10 pages)
b376ee1 docs(report): embed 12 real screenshots and align narrative with Linux VM (Ubuntu 22.04 / Python 3.10 / clean-venv/bin)
1f4b1dc feat: add 8 real terminal screenshots for q09-q12 (src/install/run/pipshow/testfile/ailog/comm/q12-src)
2d9076d chore: replace 4 script-rendered screenshots with real terminal captures (q09 build / q10 fail / q10 pass / q12 train)
